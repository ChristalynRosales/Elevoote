      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <?php
              ...
              echo "<h3>".$queryCandidates->rowCount()."</h3>";
            ?>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
            <?php
                $sqlVoters = "SELECT * FROM voters";
                $queryVoters = $conn->query($sqlVoters);
                echo "<h3>".$queryVoters->rowCount()."</h3>";
              ?>
...
<?php include 'includes/scripts.php'; ?>
 <?php
        ...
        while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
          ...
          $cstmt->bindParam(':position_id', $row['id'], PDO::PARAM_INT);
          $cstmt->execute();
          $carray = array();
          $varray = array();
          while($crow = $cstmt->fetch(PDO::FETCH_ASSOC)){
            ...
            $vstmt->bindParam(':candidate_id', $crow['id'], PDO::PARAM_INT);
            $vstmt->execute();
            array_push($varray, $vstmt->rowCount());
          }
